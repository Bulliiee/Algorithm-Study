...
/**
 * BJ_16926_배열돌리기1_이항우.java
 * 메모리: 37512 KB
 * 시간: 592 ms
 * 
 * 배열의 가장자리부터 쫙 펴서 큐에 일자로 집어넣는다.
 * 돌리는 횟수만큼 빼고 넣고 해서 다시 배열을 만든다.
 * 큐는 배열 크기 중 짝수인 크기의 절반만큼 만든다.
 * 
 * rot만큼 안돌리고 반복해서 나오니까 그만큼만 하면 더 줄어들 것 같다.
 * 큐를 무지성으로 돌리지 말고 똑 떼서 뒤로 붙힌다면 더 줄어들 것 같다.
 * 
 * @author 이항우
 *
 */
