...
/**
 * BJ_16935_배열돌리기3_이항우.java
 * 메모리: 54868 KB
 * 시간: 608 ms
 * 
 * 주어진 배열을 입력한 명령어에 맞게 잘 쪼개서 연산을 수행합니다.
 * 문제의 조건을 따라서 그대로 구현해서 설명할게 많이 없는것 같습니다.
 * 인덱스를 요리조리 움직이면서 맞게 구현합니다.
 * 
 * 비슷하게 생긴 코드가 많아서 합칠 수 있을것 같은데 능력 밖이라 더 연구 해야겠습니다.
 * 
 * @author 이항우
 *
 */
